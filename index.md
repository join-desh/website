...
<section class="section" id="why-now">
  <div class="container narrow">
    ...
    <p class="reveal" style="color:var(--text-muted);font-size:1.12rem;line-height:1.75">Policy has always been written as prose, because a human read it and supplied the judgement. That stops working the moment the thing carrying out the policy is a machine.</p>
    <p class="reveal" style="color:var(--text-muted);font-size:1.12rem;line-height:1.75;margin-top:1.2rem">Three arrivals are making that the normal case. AI is moving into the decisions: assessment, eligibility, inspection, the routing of a case from one desk to the next. Embodied intelligence is moving into execution, at the physical points where a service is actually delivered. And decentralisation primitives now let a rule run across many parties with nobody trusted holding the ledger.</p>
    <p class="reveal" style="color:var(--text-muted);font-size:1.12rem;line-height:1.75;margin-top:1.2rem">Any one of them would change governing. Together they mean the state comes to act through software: on records and money, on conduct in online space, and increasingly on things that move in the physical world. Software does not run on prose. A rule has to be specified tightly enough to execute, test and revert, and whoever writes that specification sets the defaults for everything downstream. So "software-defined" is not a metaphor we borrowed from technology. It is the only form policy can take once machines are the ones carrying it out, and almost nobody qualified to write it works in politics today.</p>
  </div>
</section>
