...
<section class="section" id="why-now">
  <div class="container narrow">
    ...
    <p class="reveal" style="color:var(--text-muted);font-size:1.12rem;line-height:1.75">More of what a person does in a day is about to be done by a machine acting on their behalf: booking, filing, claiming, registering, appealing, and increasingly moving things in the physical world rather than only records. None of that works against a counter, a queue or a paper form. Those interfaces were designed for a human with an afternoon to spare.</p>
    <p class="reveal" style="color:var(--text-muted);font-size:1.12rem;line-height:1.75;margin-top:1.2rem">So public services will need software interfaces, the way everything else eventually did. Compute went through this once already: it used to mean buying a machine, racking it and keeping it alive, and then it became a set of programmable building blocks you could assemble in an afternoon. Nobody had to be persuaded. The old way simply stopped being worth the trouble.</p>
    <p class="reveal" style="color:var(--text-muted);font-size:1.12rem;line-height:1.75;margin-top:1.2rem">Governance is next. Public services as programmable primitives instead of monoliths, composable into arrangements nobody planned for, by a state or a city or a community or one citizen with a good idea. That is a far larger change than putting a form online, and whoever specifies those primitives sets the defaults for everyone downstream. Almost nobody qualified to specify them works in politics today.</p>
  </div>
</section>
