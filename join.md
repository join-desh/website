...
<section class="hero" style="padding-bottom:2rem">
  <div class="container narrow">
    ...
    <p class="lede">A hundred people is the legal threshold to register a political party in India, our first test bed. We want that hundred to be domain experts who run the systems a country depends on. Be one of them.</p>
    <div class="stats">
      ...
      <div class="stat"><div class="num ember-text">1</div><div class="lbl">Blueprint for anywhere</div></div>
    </div>
  </div>
</section>
